    ...
    >
      ...
      <div className="absolute top-[155px] left-[30%] ">
        ...
        <AnimatedGradientText>
          ...
          <span
            className={cn(
              `animate-gradient inline bg-gradient-to-r from-[#ffaa40] via-[#9c40ff] to-[#ffaa40] bg-[length:var(--bg-size)_100%] bg-clip-text text-transparent text-5xl font-medium tracking-tight`
            )}
          >
            Client&apos;s Review
          </span>
